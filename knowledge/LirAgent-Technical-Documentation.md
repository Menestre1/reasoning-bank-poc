...
domain: knowledge
language: general
task: LirAgent Technical Documentation
keywords: как работает память, что такое consecutive_successes, как определяешь язык, агент Лирь, как работает Лирь, память агента, feedback loop, навыки, anti-pattern, инструменты агента
---
